package com.iyiyo.mvc.ui.activity.album.adapter;
...
public class FolderAdapter extends BaseAdapter {
    ...
    public FolderAdapter(Context context) {
        ...
        mImageSize = mContext.getResources().getDimensionPixelOffset(R.dimen.space_72);
    }
                ...
                if (mFolders.size() > 0) {
                    ...
                    if (f != null) {
                        Picasso.with(mContext)
                                ...
                                .resizeDimen(R.dimen.space_72, R.dimen.space_72)
                                .centerCrop()
                                .into(holder.cover);
                    } else {
