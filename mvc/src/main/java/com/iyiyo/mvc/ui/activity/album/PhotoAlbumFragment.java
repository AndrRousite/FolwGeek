...
import com.iyiyo.mvc.ui.activity.album.adapter.FolderAdapter;
import com.iyiyo.mvc.ui.activity.album.adapter.ImageGridAdapter;
import com.iyiyo.mvc.ui.activity.album.bean.Folder;
import com.iyiyo.mvc.ui.activity.album.bean.Image;
import com.iyiyo.mvc.ui.fragment.BaseFragment;
import com.iyiyo.utils.FileUtils;
import com.iyiyo.utils.ScreenUtils;
...
public class PhotoAlbumFragment extends BaseFragment {
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            throw new ClassCastException("The Activity must implement MultiImageSelectorFragment" +
                    ".Callback interface...");
        }
    }
        ...
        if (ContextCompat.checkSelfPermission(getContext(), Manifest.permission
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    Toast.makeText(getActivity(), "图片错误", Toast
                            .LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(getActivity(), "没有系统相机", Toast.LENGTH_SHORT)
                        .show();
            }
        }
    }
    ...
    private void requestPermission(final String permission, String rationale, final int
        ...
        if (shouldShowRequestPermissionRationale(permission)) {
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton("好", new DialogInterface
                            .OnClickListener() {
                        @Override
            ...
            if (mode == MODE_MULTI) {
                if (resultList.contains(image.path)) {
                    ...
                    if (selectImageCount() == resultList.size()) {
                        Toast.makeText(getActivity(), "已经达到最高选择数量", Toast
                                .LENGTH_SHORT).show();
                        return;
                    }
