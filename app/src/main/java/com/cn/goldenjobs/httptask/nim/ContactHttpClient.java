package com.cn.goldenjobs.httptask.nim;
...
public class ContactHttpClient {
    ...
    public void register(String account, String nickName, String password, final ContactHttpCallback<Void> callback) {
        String url = APIConfig.apiServer() + API_NAME_REGISTER;
    ...
    private String readAppKey() {
        try {
            ApplicationInfo appInfo = JFWApplication.getInstance().getPackageManager()
                    .getApplicationInfo(JFWApplication.getInstance().getPackageName(), PackageManager.GET_META_DATA);
            if (appInfo != null) {
