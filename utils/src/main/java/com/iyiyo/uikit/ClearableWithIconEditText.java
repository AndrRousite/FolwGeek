 ...
 * 
 */
public class ClearableWithIconEditText extends EditText implements OnTouchListener, TextWatcher {
	...
	public ClearableWithIconEditText(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public ClearableWithIconEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public ClearableWithIconEditText(Context context) {
		super(context);
		init();
	}

	private void init() {
		ClearableWithIconEditText.this.setOnTouchListener(this);
		ClearableWithIconEditText.this.addTextChangedListener(this);
	...
	public boolean onTouch(View v, MotionEvent event) {
		ClearableWithIconEditText et = ClearableWithIconEditText.this;
		...
		if (event.getX() > et.getWidth() - et.getPaddingRight() - deleteImage.getIntrinsicWidth()) {
			et.setText("");
			ClearableWithIconEditText.this.removeClearButton();
		}
		return false;
	}
	...
	public void onTextChanged(CharSequence s, int start, int before, int count) {
		ClearableWithIconEditText.this.manageClearButton();
	}
